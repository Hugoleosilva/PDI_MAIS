...
## Corpus Check
- 81 files · ~38,026 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 525 nodes · 986 edges · 31 communities (23 shown, 5 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 20 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `eeb645d6`
...
Cohesion: 0.06
Nodes (59): DetailPanel(), PanelData, edgeTypes, HelperLines(), selector(), ActionNode(), AreaNode(), borderStyle() (+51 more)

### Community 1 - "PlanningView.tsx"
Cohesion: 0.10
Nodes (36): pct(), PctBar(), addDays(), daysBetween(), num(), PLAN_BADGE, PlanningView(), ProgMode (+28 more)

### Community 2 - "auth.ts"
Cohesion: 0.18
Nodes (9): GET(), runtime, Home(), PlanningPage(), { handlers, auth, signIn, signOut }, getPdiByUserId(), next-auth, Session (+1 more)
...
Cohesion: 0.26
Nodes (10): ImportPage(), ImportForm(), ImportTabs(), DraftArea, emptyAction(), emptyArea(), KINDS, ManualBuilder() (+2 more)
...
Cohesion: 0.06
Nodes (50): GET(), runtime, POST(), runtime, POST(), runtime, applySync(), Layout (+42 more)
...
Cohesion: 0.14
Nodes (23): GroupNode(), PdiCanvas(), EmptyState(), GeminiButton(), KINDS, formatDateTime(), ReportButton(), ASKS (+15 more)

### Community 11 - "Progresso do PDI+"
Cohesion: 0.04
Nodes (42): Prompt inicial — PDI+, Rodada 1 — Fundação e dados, Rodada 2 — Canvas read-only, Rodada 3 — Extensão Manifest V3, Rodada 4 — Drawer, edição manual, Gemini, modo gestor, PWA, ✅ Extra — Insight para 1-on-1 (Gemini), Progresso do PDI+, ⏭️ Próximas rodadas (+34 more)
...
### Community 30 - "addReportSnapshot"
Cohesion: 0.67
