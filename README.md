...
1. Suba `docs/PDI-PLUS-SPEC.md` como **Conhecimento do projeto**.
2. Cole `docs/PROJECT-INSTRUCTIONS.md` em **Instruções personalizadas**.
3. Abra a primeira conversa com a Rodada 1 de `docs/KICKOFF-PROMPT.md`.
